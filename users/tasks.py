...
def send_user_verification_otp(self, email, otp):
    try:
        ...
        logger.info(f"Task Success: Sent OTP")
    except Exception as e:
        logger.error(f"Task Failed: Send OTP: {str(e)}", exc_info=True)
        raise e
...
def send_user_invite_email(self, email, invite_link):
    try:
        ...
        logger.info(f"Task Success: Sent invite")
    except Exception as e:
        logger.error(f"Task Failed: Send invite: {str(e)}", exc_info=True)
        raise e
...
def send_password_reset_email(self, email, reset_link):
    try:
        ...
        logger.info(f"Task Success: Sent password reset")
    except Exception as e:
        logger.error(f"Task Failed: Send password reset: {str(e)}", exc_info=True)
        raise e
...
def send_verification_link_email(self, email, link):
    try:
        ...
        logger.info(f"Task Success: Sent verification link")
    except Exception as e:
        logger.error(f"Task Failed: Send verification link: {str(e)}", exc_info=True)
        raise e
...
def hard_delete_unverified_users():
    try:
        ...
        logger.info(f"Task Success: Hard deleted {count} unverified users.")
        return f"Hard deleted {count} unverified users."
    except Exception as e:
        logger.error(f"Task Failed: hard_delete_unverified_users: {str(e)}", exc_info=True)
        raise e
...
def clear_blacklisted_tokens():
    ...
    try:
        ...
        logger.info(f"Task Success: Purged {expired_count} expired tokens.")
        return f"Purged {expired_count} expired tokens."
    except Exception as e:
        logger.error(f"Task Failed: clear_blacklisted_tokens: {str(e)}", exc_info=True)
        raise e
...
def hard_delete_soft_deleted_users():
    ...
    try:
        ...
        logger.info(f"Task Success: Hard deleted {count} self-deleted users.")
        return f"Hard deleted {count} self-deleted users."
    except Exception as e:
        logger.error(f"Task Failed: hard_delete_soft_deleted_users: {str(e)}", exc_info=True)
        raise e
