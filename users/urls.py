...
from .views import RegisterAPIView , LoginAPIView , ResetPasswordAPIView , LogoutAPIView , TokenRefreshAPIView , UserListCreateAPIView, UserDetailUpdateDeleteAPIView , OrganizationCreateAPIView , VerifyEmailAPIView , ResendOTPAPIView , InviteUserAPIView , InviteRegisterAPIView , LoginOTPVerifyAPIView , reset_password_view ,ForgotPasswordAPIView 


urlpatterns = [
    path("auth/<uuid:tenant_id>/register/", RegisterAPIView.as_view()),
